    ...
    return(
        <div className="c-usermenu">
            ...
            <div className="c-usermenu__addtowishlist__div usermenu-btndiv">
                <Link to="/wishlist"><button className="usermenu-btn c-usermenu__addtowishlist__div">Add vinyl to Wishlist</button></Link>
            </div>
            ...
            <div className="c-usermenu__logout__div usermenu-btndiv">
                <button className="usermenu-btn c-usermenu__logout__div_btn">LogOut</button>
            </div>
        </div>
    )
}
